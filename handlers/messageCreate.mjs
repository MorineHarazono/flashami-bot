...
export default async(message) => {
  ...
  if (message.content.match(/Day1車割！/)) {
    await message.reply(`チームフシギダネ：ニュイ,きぺお,サップ,きほもり,ゴゴティー,つな\n`+`チームイーブイ：あづき,まっすー,さっきー,みるく,きゃあ。,あいりす\n`+`チームヒメグマ：ばんしー,わたみ,しまとー,ヨヨギ,まんじ,すしろー\n`);
  }
  if (message.content.match(/Day2車割！/)) {
    await message.reply(`チームフシギダネ：きほもり,サップ,ようる,ばんしぃ,さっきー,つな,すしろー\n`+`チームイーブイ：きゃあ。,しまとー,ネンネン,わたみ,まんじ,みるく,ヨヨギ\n`+`チームヒメグマ：もりね,きぺお,ニュイ,あいりす,ゴゴティー,あづき,まっすー\n`);
  }
  if (message.content.match(/Day3車割！/)) {
    await message.reply(`チームフシギダネ：きぺお,しまとー,ゴゴティー,まっすー,つな,ようる\n`+`チームイーブイ：きゃあ。,ネンネン,ばんしぃ,あづき,みるく,ヨヨギ\n`+`チームヒメグマ：もりね,サップ,さっきー,きほもり,ニュイ,かめさん\n`);
  }
  if (message.content.match(/昼ごはん！/)) {
    ...
    await message.reply("ついにFlacation sggが始めるしゃみ〜！！始まった感のある写真を見てみたいしゃみ！");
  }
    if (message.content.match(/Day2出発！/)) {
    await message.reply("Day2が始めるしゃみ〜！！他の車を寄せ付けない躍動感のある写真を見てみたいしゃみ！");
  }
...
const mentors = [
  ...
  },
  {
    ...
    summerMemory: "17期ですが選択するとこなくて16期にしてます！"
  },
  {
    name: "ばんしぃ",
    leaders: "17期",
  ...
  },
  {
    ...
    region: "関東🏮",
    license: "勝者だが敗者（ペーパー）",
    summerMemory: "これはこれは！記念すべきカメラマンデビュー！同時に1キロ飛んでった🙌"
  },
  {
    name: "まっすー",
    leaders: "16期",
    ...
    region: "東海🥠",
    license: "勝者だが敗者（ペーパー）",
    summerMemory: "ぶどう狩りに行った！！！コテージで星見た！！！もうすぐディズニー行く！！！"
  },
  {
    name: "わたみ",
    leaders: "15期",
  ...
  },
  {
    ...
    region: "関東🏮",
    license: "勝者だが敗者（ペーパー）",
    summerMemory: "今イタリアエジプト旅行をしているよ〜〜"
  },
  {
    name: "ヨヨギ",
    leaders: "16期",
  ...
  },
  {
    ...
    region: "東海🥠",
    license: "勝者",
    summerMemory: "フラケーションを1番の夏の思い出にします💪"
  },
  {
    name: "ネンネン",
    leaders: "15期",
