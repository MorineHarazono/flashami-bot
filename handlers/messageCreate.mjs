...
export default async(message) => {
  ...
  if (message.content.match(/Day2車割！/)) {
    await message.reply(`チーム無遠慮族：きぺお、みるく、ありこ、あっぷる、ちゃんぽん、うらっしゅ、ヨヨギ\n`+`チーム誇食道化師：すず、KURO、きなこ、チロル、だす、あづき、はーちぃ\n`+`チーム母：きほもり、さーさん、ばく、ゆるゆる、なつつ、あるが、さぁ坊\n`+`チーム徐々慣親：もりね、まっすー、みぞ、きょーりゅー、かめさん、さく\n`+`チーム奇人：ゆわ、ほしょ、ゆっきー、あるちゃん、しろ、おまつ\n`);
  }
